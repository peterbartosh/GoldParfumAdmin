...
fun AddUserScreen(
    ...
    Column(modifier = Modifier.fillMaxSize(),
        ...
        MyAlertDialog(
            text = "Добавить пользователя с номером $code${phoneNumberState.value} в чёрный список?",
        ...
        SubmitButton(text = "Добавить в чёрный список", enabled = validInputsState.value) {
