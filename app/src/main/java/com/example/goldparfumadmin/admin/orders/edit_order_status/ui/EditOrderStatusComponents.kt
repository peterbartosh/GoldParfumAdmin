                ...
                Row(
                    ...
                    Column(
                        ...
                        orderProducts.forEach { orderProduct ->
                            ...
                            Text(text = orderProduct.productId.toString(), fontSize = 10.sp)
                            Spacer(modifier = Modifier.height(1.dp))
                            Text(text = orderProduct.amount.toString(), fontSize = 10.sp)
                            Spacer(modifier = Modifier.height(1.dp))
                            Text(text = orderProduct.isCashPrice.toString(), fontSize = 10.sp)
